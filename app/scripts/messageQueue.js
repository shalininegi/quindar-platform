...
module.exports = function(app, bodyParser, fs, syslogger, logger, helper) {
  ...
  **/
  app.post('/services/v1/messaging/attitude/:topic', function(req, res) {
    ...
    // var xServerEndpoint = 'amqp://audacyapp:quindar@data02.audacy.space/develop';
    // var xTopic = 'audacy.telemetry.attitude';
    // var xReqBody = '{"q1":7890, "q2":7892}';
    // publishToTopic(xServerEndpoint, xTopic, xReqBody);
